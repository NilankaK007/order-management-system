...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <a href="{{ route('transactions.index') }}" class="nav-btn">Manage Finances</a>
    ...
    <div class="container">
        ...
        <div class="stats">
            <div class="stat-card income" onclick="window.location.href='{{ route('transactions.index') }}'">
                <h3>Total Income</h3>
                <div class="amount">Rs {{ number_format($totalIncome, 2) }}</div>
            </div>
            <div class="stat-card outcome" onclick="window.location.href='{{ route('transactions.index') }}'">
                <h3>Total Outcome</h3>
                <div class="amount">Rs {{ number_format($totalOutcome, 2) }}</div>
            </div>
            <div class="stat-card profit">
                <h3>Net Profit</h3>
                <div class="amount">Rs {{ number_format($profit, 2) }}</div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="section-header">
                ...
                <a href="{{ route('orders.create') }}" class="btn btn-add">+ Add Order</a>
            </div>
