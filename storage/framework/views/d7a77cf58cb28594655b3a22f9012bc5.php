...
<body>
    <div class="container">
        ...
        <div class="detail-row">
            ...
            <div class="detail-value"><?php echo e($order->customer_address); ?></div>
        </div>
        
        <div class="detail-row">
            <div class="detail-label">Description:</div>
            <div class="detail-value"><?php echo e($order->description); ?></div>
        </div>
        
        <div class="detail-row">
            <div class="detail-label">Price:</div>
            <div class="detail-value"><span class="price">Rs <?php echo e(number_format($order->price, 2)); ?></span></div>
        </div>
        
        <div class="detail-row">
            <div class="detail-label">Order Date:</div>
            <div class="detail-value"><?php echo e($order->order_date->format('F d, Y')); ?></div>
        </div>
        
        <div class="detail-row">
            <div class="detail-label">Delivery Date:</div>
            <div class="detail-value"><?php echo e($order->delivery_date->format('F d, Y')); ?></div>
        </div>
        
        <div class="detail-row">
            <div class="detail-label">Status:</div>
            <div class="detail-value">
                <span class="status <?php echo e($order->status); ?>"><?php echo e(ucfirst($order->status)); ?></span>
            </div>
        </div>
        
        <div class="detail-row">
            <div class="detail-label">Created At:</div>
            <div class="detail-value"><?php echo e($order->created_at->format('F d, Y h:i A')); ?></div>
        </div>

        <?php if($order->status == 'completed'): ?>
        <div class="detail-row">
            <div class="detail-label">Completed At:</div>
            <div class="detail-value"><?php echo e($order->updated_at->format('F d, Y h:i A')); ?></div>
        </div>
        <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\order management\order-management\resources\views/orders/show.blade.php ENDPATH**/ ?>