...
<body>
    <div class="header">
        <h1><?php echo e(auth()->user()->business_name); ?> - Financial Transactions</h1>
    ...
    <div class="container">
        ...
        <div class="stats">
            <div class="stat-card income">
                <h3>Total Income</h3>
                <div class="amount">Rs <?php echo e(number_format($transactions->where('type', 'income')->sum('amount'), 2)); ?></div>
            </div>
            <div class="stat-card outcome">
                <h3>Total Outcome</h3>
                <div class="amount">Rs <?php echo e(number_format($transactions->where('type', 'outcome')->sum('amount'), 2)); ?></div>
            </div>
            <div class="stat-card profit">
                <h3>Net Profit</h3>
                <div class="amount">Rs <?php echo e(number_format($transactions->where('type', 'income')->sum('amount') - $transactions->where('type', 'outcome')->sum('amount'), 2)); ?></div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="section-header">
                ...
                <div>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-back">← Back to Dashboard</a>
                    <a href="<?php echo e(route('transactions.create')); ?>" class="btn btn-add">+ Add Transaction</a>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="type-badge <?php echo e($transaction->type); ?>"><?php echo e(ucfirst($transaction->type)); ?></span></td>
                            <td><?php echo e($transaction->description); ?></td>
                            <td style="color: <?php echo e($transaction->type == 'income' ? '#4CAF50' : '#f44336'); ?>; font-weight: bold;">
                                <?php echo e($transaction->type == 'income' ? '+' : '-'); ?> Rs <?php echo e(number_format($transaction->amount, 2)); ?>

                            </td>
                            <td>
                                <form method="POST" action="<?php echo e(route('transactions.destroy', $transaction->id)); ?>" style="display: inline;">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\order management\order-management\resources\views/transactions/index.blade.php ENDPATH**/ ?>